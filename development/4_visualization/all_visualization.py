...
file_mid = MidiFile("5_mid-examples/bth-str-trio.mid")
file_stream = converter.parse("5_mid-examples/bth-str-trio.mid")
...
# --- visualization --- #
def schritt(i):
    global count_thickness_i, count_pitch_i, count_color_i, start_value, all_pitches_d_m, all_velocities_d, count_instr, x2, y2, freq, ampl
    achsen.clear()
