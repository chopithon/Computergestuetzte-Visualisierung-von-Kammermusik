...
end_values_i = [] # Index der letzten Elemente jedes Instrumentes
...
for instr in all_pitches_d_m:
    ...
    end_value = len(listed)
    end_values_i.append(end_value)

    print("endvalue =", end_value)
    ...
    for instr in all_pitches_d_m:
        ...
        if count_instr == 0:
            ...
            while count_100 < 100:
                count_100 += 1
                count_pitches_100 += 1
                if count_pitches_100 == end_values_i[count_instr]:
                    break
